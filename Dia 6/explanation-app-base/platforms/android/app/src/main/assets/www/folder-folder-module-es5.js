  ...
  function srcAppSharedPipesTruncatePipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TruncatePipe = /*#__PURE__*/function () {
      ...
      _createClass(TruncatePipe, [{
        key: "transform",
        value: function transform(text, n) {
          //comprobar el numero de letras de plabra
          //comprobar si la la palabra empiza con la misma letra
          var lastWord = text.substring(0, n).split('').pop();
          var textSecondatyWithMargin = text.substring(0, n + 10).split(' ');
          console.log(textSecondatyWithMargin); // !n si n es igual a 
