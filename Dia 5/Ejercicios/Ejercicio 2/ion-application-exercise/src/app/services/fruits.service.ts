...
//Interfaces
import { IFruit } from '../interfaces/index'
@Injectable({
  providedIn: 'root'
})
export class FruitsService {
   ...
   * @param index 
   */
  public getFruitByIndex(index:number):IFruit{
   ...
   *  @param fruit
   */
  public updateRemoteFruit(fruit:IFruit): Observable<IFruit> {
    return this.httpClient.put<IFruit>(environment.URL_SERVER+'fruits/'+fruit.id,fruit);
  }

  public getAllRemoteFruit(): Observable<IFruit[]>{
   return this.httpClient.get<IFruit[]>(environment.URL_SERVER+'fruits');
  }
}
